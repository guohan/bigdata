...
import  com.kit.kafka.ws.producer.KafkaWebsocketProducerFactory;
    ...
    public void run() {
        try {
            ...
            String inputTransformClassName =
                    wsProps.getProperty("ws.inputTransformClass", "com.kit.kafka.ws.transforms.Transform");
            String outputTransformClassName =
                    wsProps.getProperty("ws.outputTransformClass", "com.kit.kafka.ws.transforms.Transform");
