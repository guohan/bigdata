...
package com.kit.kafka.ws.consumer;
...
/**
 * 
 * @author Administrator kafka 消费者
 */
public class KafkaConsumer {
	...
	public KafkaConsumer(Properties configProps, final ExecutorService executorService, final Transform transform,
			final String topics, final Session session) {
	...
	public KafkaConsumer(ConsumerConfig consumerConfig, final ExecutorService executorService,
			final Transform transform, final List<String> topics, final Session session) {
		this.remoteEndpoint = session.getAsyncRemote();
	...
	static public class KafkaConsumerTask implements Runnable {
		...
		public KafkaConsumerTask(KafkaStream stream, Async remoteEndpoint, final Transform transform,
