...
import com.kit.spark.entity.POITrafficData;
import com.kit.spark.entity.TotalTrafficData;
import com.kit.spark.entity.WindowTrafficData;
import com.kit.spark.util.GeoDistanceCalculator;
import com.kit.spark.vo.AggregateKey;
 ...
 * @desc 处理kafka生产的iot数据 计算具体的traffic data明细
 *
 */
