...
public class IoTDataProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		properties.put("serializer.class", "com.kit.kafka.IoTDataEncoder");
...
//				"/home/kitdev/kitdev.keytab"
	...
	private void generateIoTEvent(Producer<String, IoTData> producer, String topic) throws InterruptedException {
		List<String> routeList = Arrays.asList(new String[]{"Route-37", "Route-43", "Route-82","Route-81","Route-83","Route-84"});
